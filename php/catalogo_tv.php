<?php
    ...
    if (isset($_POST['azione']) && $_POST['azione'] === 'aggiungi_al_carrello') {
        ...
        header("Location: catalogo_tv.php");
        exit();
    }
?>
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body>
        ...
        <div class="cont">
            ...
            // Inizializza la variabile booleana per verificare se ci sono prodotti di tipo 'tv'
            $tvPresenti = false;
            ...
            foreach ($prodotti as $prodotto) {
                ...
                if ($tipologia !== 'tv') {
                    continue; // Salta il prodotto se la tipologia non è 'tv'
                }
                

                // Imposta la variabile booleana a true se almeno un prodotto è di tipo 'tv'
                $tvPresenti = true;
                ...
                if(isset($_SESSION['loggato'])){
                    ...
                    echo '<td class="td">';
                    echo nl2br('<p class="des">' . $descrizione . '</p>');
                    echo '<p style="margin-left: 2px;margin-bottom: 5px;" class="prezzo">Prezzo: ' . $prezzo . '€</p>';
            ...
            if (!$tvPresenti) {
                echo '<h3 class="titolo">Il catalogo delle tv è vuoto :(</h3>';
            }
            ?>
