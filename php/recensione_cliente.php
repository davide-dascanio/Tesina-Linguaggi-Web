...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body>
        ...
        <div class="cont">
            ...
            <h1 class="titolo">Lascia una recensione per <?php echo $nome; ?>:</h1>

            <table>
                <tr>
                    <td>
                        <form class="form" method="post" action="../res/processa_recensioni.php">
                            ...
                            <textarea style="width:700px; height:100px; resize:none; vertical-align:top;" class="input" name="recensione" placeholder="Scrivi una recensione..." required></textarea>
                            <br><br><br>
