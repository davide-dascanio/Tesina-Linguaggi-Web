...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body>
        ...
        <div class="cont">
            ...
            // Inizializza la variabile booleana per verificare se ci sono prodotti di tipo 'soundbar'
            $soundbarPresenti = false;
            ...
            foreach ($prodotti as $prodotto) {
                ...
                if ($tipologia !== 'soundbar') {
                    continue; // Salta il prodotto se la tipologia non è 'soundbar'
                }
                

                // Imposta la variabile booleana a true se almeno un prodotto è di tipo 'soundbar'
                $soundbarPresenti = true;
            ...
            if (!$soundbarPresenti) {
                echo '<h3 class="titolo">Il catalogo delle soundbar è vuoto :(</h3>';
            }
            ?>
